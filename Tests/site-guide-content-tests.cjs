...
for (const locale of locales) {
  ...
  assert.equal((source.match(/data-umami-event="download-cta-click" data-umami-event-location="guide-(?:hero|after-steps|bottom)"/g) || []).length, 3, locale + ": three download CTAs");
