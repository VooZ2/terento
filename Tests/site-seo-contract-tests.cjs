...
assert.match(read("site/index.html"), /provider-list\.js\?v=20260912-bbbike-types-v1/);
assert.match(read("site/provider-list.js"), /https:\/\/api\.terento\.app\/maps\/catalog-v4\.json/);
