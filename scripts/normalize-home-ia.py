...
HOME_COPY = {
    "en": {
        ...
        "scope": "Terento is designed for Garmin smartwatches with map support. The Compatibility page shows exact models and variants with at least one successful shared installation; a missing model is not necessarily unsupported.",
        "compatibility_answer": "See the <a href=\"/compatibility/\" data-umami-event=\"compatibility-link-click\" data-umami-event-location=\"home-faq-compatibility\">Compatibility page</a> for exact Garmin models and variants with at least one successful shared installation. A missing model is not necessarily unsupported.",
    ...
    "de": {
        ...
        "scope": "Terento ist für Garmin-Smartwatches mit Kartenunterstützung entwickelt. Die Kompatibilitätsseite zeigt genaue Modelle und Varianten mit mindestens einer erfolgreich geteilten Installation; ein fehlendes Modell ist nicht unbedingt ununterstützt.",
        "compatibility_answer": "Auf der <a href=\"/de/compatibility/\" data-umami-event=\"compatibility-link-click\" data-umami-event-location=\"home-faq-compatibility\">Kompatibilitätsseite</a> findest du genaue Garmin-Modelle und Varianten mit mindestens einer erfolgreich geteilten Installation. Ein fehlendes Modell ist nicht unbedingt ununterstützt.",
    ...
    "fr": {
        ...
        "scope": "Terento est conçu pour les montres Garmin prenant en charge les cartes. La page Compatibilité affiche les modèles et variantes exacts avec au moins une installation réussie partagée ; l’absence d’un modèle ne signifie pas qu’il n’est pas pris en charge.",
        "compatibility_answer": "Consultez la <a href=\"/fr/compatibility/\" data-umami-event=\"compatibility-link-click\" data-umami-event-location=\"home-faq-compatibility\">page Compatibilité</a> pour voir les modèles et variantes Garmin exacts avec au moins une installation réussie partagée. L’absence d’un modèle ne signifie pas qu’il n’est pas pris en charge.",
    ...
    "pl": {
        ...
        "scope": "Terento jest przeznaczone dla zegarków Garmin obsługujących mapy. Strona zgodności pokazuje dokładne modele i warianty z co najmniej jedną udaną, udostępnioną instalacją; brak modelu nie oznacza, że nie jest obsługiwany.",
        "compatibility_answer": "Na <a href=\"/pl/compatibility/\" data-umami-event=\"compatibility-link-click\" data-umami-event-location=\"home-faq-compatibility\">stronie zgodności</a> znajdziesz dokładne modele i warianty Garmin z co najmniej jedną udaną, udostępnioną instalacją. Brak modelu nie oznacza, że nie jest obsługiwany.",
    ...
    "cs": {
        ...
        "scope": "Terento je určeno pro hodinky Garmin s podporou map. Stránka Kompatibilita zobrazuje konkrétní modely a varianty s alespoň jednou úspěšnou sdílenou instalací; chybějící model nemusí znamenat, že není podporován.",
        "compatibility_answer": "Na stránce <a href=\"/cs/compatibility/\" data-umami-event=\"compatibility-link-click\" data-umami-event-location=\"home-faq-compatibility\">Kompatibilita</a> najdete konkrétní modely a varianty Garmin s alespoň jednou úspěšnou sdílenou instalací. Chybějící model nemusí znamenat, že není podporován.",
    ...
    "it": {
        ...
        "scope": "Terento è progettato per gli smartwatch Garmin con supporto alle mappe. La pagina Compatibilità mostra i modelli e le varianti esatti con almeno un’installazione riuscita condivisa; l’assenza di un modello non significa necessariamente che non sia supportato.",
        "compatibility_answer": "Consulta la pagina <a href=\"/it/compatibility/\" data-umami-event=\"compatibility-link-click\" data-umami-event-location=\"home-faq-compatibility\">Compatibilità</a> per i modelli e le varianti Garmin esatti con almeno un’installazione riuscita condivisa. L’assenza di un modello non significa necessariamente che non sia supportato.",
