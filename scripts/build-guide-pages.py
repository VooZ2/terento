...
FLOW_COPY = {
    "en": {
        ...
        "installation_failed": "On the failed installation screen, choose “Report issue”. Terento copies a diagnostic report and opens GitHub. Review the report before posting: GitHub issues are public. If you prefer email, paste the report into your message to support.",
    ...
    "de": {
        ...
        "installation_failed": "Wähle nach einer fehlgeschlagenen Installation „Report issue“. Terento kopiert einen Diagnosebericht und öffnet GitHub. Prüfe den Bericht vor dem Veröffentlichen: GitHub-Issues sind öffentlich. Für Hilfe per E-Mail füge den Bericht in deine Nachricht an den Support ein.",
    ...
    "fr": {
        ...
        "installation_failed": "Sur l’écran d’échec de l’installation, choisissez « Report issue ». Terento copie un rapport de diagnostic et ouvre GitHub. Vérifiez le rapport avant de le publier : les issues GitHub sont publiques. Pour une aide par e-mail, collez le rapport dans votre message au support.",
    ...
    "pl": {
        ...
        "installation_failed": "Na ekranie nieudanej instalacji wybierz „Report issue”. Terento kopiuje raport diagnostyczny i otwiera GitHub. Sprawdź raport przed publikacją: zgłoszenia na GitHubie są publiczne. Jeśli wolisz e-mail, wklej raport do wiadomości do pomocy technicznej.",
    ...
    "cs": {
        ...
        "installation_failed": "Na obrazovce neúspěšné instalace zvolte „Report issue“. Terento zkopíruje diagnostickou zprávu a otevře GitHub. Před zveřejněním zprávu zkontrolujte: hlášení na GitHubu jsou veřejná. Pokud dáváte přednost e-mailu, vložte zprávu do e-mailu podpoře.",
    ...
    "it": {
        ...
        "installation_failed": "Nella schermata di installazione non riuscita, scegli “Report issue”. Terento copia un rapporto diagnostico e apre GitHub. Controlla il rapporto prima di pubblicarlo: le issue su GitHub sono pubbliche. Se preferisci l’e-mail, incolla il rapporto nel messaggio all’assistenza.",
