...
def image_markup(asset: str, width: int, height: int, alt: str, caption: str) -> str:
    ...
    return f'''<figure class="guide-screenshot">
          <picture>
            ...
            <img src="/assets/app/optimized/{stem}-{fallback_width}.avif" srcset="{sources}" sizes="(max-width: 760px) 100vw, 42vw" width="{width}" height="{height}" loading="lazy" decoding="async" alt="{esc(alt)}">
          </picture>
...
TRANSLATIONS = {
    "de": {
        ...
        "steps": [
            ...
            {"title": "Garmin verbinden", "body": "Verbinde die Uhr mit einem USB-Datenkabel. Garmin-Uhren mit MTP können 1–2 Minuten brauchen, bis sie erscheinen. Lass die Uhr verbunden und gib Terento Zeit, die Erkennung abzuschließen.", "note": "Schließe Garmin Express, OpenMTP oder andere Programme, die die Uhr bereits verwenden könnten.", "image": {"asset": "your-garmin", "width": 2205, "height": 1348, "alt": "Terento zeigt eine verbundene Garmin-Uhr und den Gerätestatus", "caption": "Garmin-Uhren mit MTP können nach dem Verbinden 1–2 Minuten brauchen, bis sie erscheinen."}},
