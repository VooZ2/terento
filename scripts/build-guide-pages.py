...
COPY_REFINEMENTS = {
    "en": {
        ...
        "current_beta": "Three map providers + local import",
        ...
        "step2_body": "Choose any of the three map providers and a region. Terento shows the map size and available space before you install. You can also add a supported map file from your Mac.",
    ...
    "de": {
        ...
        "current_beta": "Drei Kartenanbieter + lokaler Import",
        ...
        "step2_body": "Wähle einen der drei Kartenanbieter und eine Region. Terento zeigt Kartengröße und freien Speicher, bevor du installierst. Du kannst auch eine unterstützte Kartendatei von deinem Mac hinzufügen.",
    ...
    "fr": {
        ...
        "current_beta": "Trois fournisseurs de cartes + import local",
    ...
    "pl": {
        ...
        "current_beta": "Trzech dostawców map + lokalny import",
        ...
        "step2_body": "Wybierz jednego z trzech dostawców map i region. Terento pokaże rozmiar mapy i wolne miejsce przed instalacją. Możesz też dodać obsługiwany plik mapy z Maca.",
    ...
    "cs": {
        ...
        "step2_body": "Vyberte jednoho ze tří poskytovatelů map a oblast. Terento před instalací zobrazí velikost mapy a volné místo. Z Macu můžete také přidat podporovaný mapový soubor.",
    ...
    "it": {
        ...
        "current_beta": "Tre provider di mappe + importazione locale",
        ...
        "step2_body": "Scegli uno dei tre provider di mappe e una regione. Terento mostra le dimensioni della mappa e lo spazio disponibile prima dell’installazione. Puoi anche aggiungere un file cartografico supportato dal Mac.",
...
FLOW_COPY = {
    "en": {
        ...
        "install_substeps": [("Choose from the catalog", "Choose a region from one of the three map providers in the catalog."), ("Upload your own map", "Add a compatible .img map from your Mac.")],
    ...
    "de": {
        ...
        "install_substeps": [("Aus dem Katalog wählen", "Wähle eine Region aus dem Katalog eines der drei Kartenanbieter."), ("Eigene Karte hochladen", "Füge eine kompatible .img-Karte von deinem Mac hinzu.")],
    ...
    "fr": {
        ...
        "install_substeps": [("Choisir dans le catalogue", "Choisissez une région dans le catalogue de l’un des trois fournisseurs de cartes."), ("Importer votre carte", "Ajoutez une carte .img compatible depuis votre Mac.")],
    ...
    "pl": {
        ...
        "install_substeps": [("Wybierz z katalogu", "Wybierz region z katalogu jednego z trzech dostawców map."), ("Dodaj własną mapę", "Dodaj zgodną mapę .img z Maca.")],
    ...
    "cs": {
        ...
        "install_substeps": [("Vybrat z katalogu", "Vyberte oblast z katalogu jednoho ze tří poskytovatelů map."), ("Přidat vlastní mapu", "Přidejte kompatibilní mapu .img z Macu.")],
    ...
    "it": {
        ...
        "install_substeps": [("Scegli dal catalogo", "Scegli una regione dal catalogo di uno dei tre provider di mappe."), ("Aggiungi la tua mappa", "Aggiungi una mappa .img compatibile dal Mac.")],
