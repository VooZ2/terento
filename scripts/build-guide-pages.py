...
FLOW_COPY = {
    "en": {
        ...
        "compatibility_note": "See real successful installation results for exact Garmin models and variants. The Compatibility page is not a complete supported-device list. After connection, Terento checks the detected device and tells you whether installation can safely continue.",
        "steps_eyebrow": "The workflow",
    ...
    "de": {
        ...
        "compatibility_note": "Sieh dir reale erfolgreiche Installationsergebnisse für genaue Garmin-Modelle und Varianten an. Die Kompatibilitätsseite ist keine vollständige Liste unterstützter Geräte. Nach dem Verbinden prüft Terento das erkannte Gerät und sagt dir, ob die Installation sicher fortgesetzt werden kann.",
    ...
    "fr": {
        ...
        "compatibility_note": "Consultez les résultats réels d’installations réussies pour les modèles et variantes Garmin exacts. La page Compatibilité n’est pas une liste exhaustive des appareils pris en charge. Après la connexion, Terento vérifie l’appareil détecté et vous indique si l’installation peut continuer en toute sécurité.",
    ...
    "pl": {
        ...
        "compatibility_note": "Zobacz rzeczywiste wyniki udanych instalacji dla dokładnych modeli i wariantów Garmin. Strona zgodności nie jest pełną listą obsługiwanych urządzeń. Po podłączeniu Terento sprawdzi wykryte urządzenie i powie, czy można bezpiecznie kontynuować instalację.",
    ...
    "cs": {
        ...
        "compatibility_note": "Podívejte se na skutečné výsledky úspěšných instalací pro konkrétní modely a varianty Garmin. Stránka Kompatibilita není úplným seznamem podporovaných zařízení. Po připojení Terento zkontroluje rozpoznané zařízení a řekne vám, zda lze bezpečně pokračovat v instalaci.",
    ...
    "it": {
        ...
        "compatibility_note": "Consulta i risultati reali delle installazioni riuscite per i modelli e le varianti Garmin esatti. La pagina Compatibilità non è un elenco completo dei dispositivi supportati. Dopo il collegamento, Terento controlla il dispositivo rilevato e ti dice se puoi continuare l’installazione in sicurezza.",
