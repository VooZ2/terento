...
ISSUES_URL = "https://github.com/VooZ2/terento/issues/new/choose"
...
COMMON = {
    "en": {
        ...
        "meta_description": "Install third-party maps on a Garmin smartwatch with map support from an Apple Silicon Mac with Terento. Connect, choose a third-party map, review storage and install safely.",
...
COPY_REFINEMENTS = {
    "en": {
        ...
        "meta_description": "Install third-party maps on a Garmin smartwatch with map support from an Apple Silicon Mac. Connect your watch, choose a map or upload your own .img file, and finish in three simple steps with Terento.",
        ...
        "current_beta": "Four map providers + local import",
        "compatibility_note": "The Compatibility page shows exact Garmin models and variants with at least one successful shared installation. The list grows as more successful installations are shared. A missing model does not mean it is unsupported; it may simply not have a successful shared installation for that exact model and variant yet. Terento is intended for Garmin smartwatches with map support. After you connect your watch, Terento checks it and tells you whether you can continue safely.",
        ...
        "step2_body": "Choose any of the four map providers and a region. Terento shows the map size and available space before you install. You can also add a supported map file from your Mac.",
    ...
    "de": {
        ...
        "meta_description": "Installiere Drittanbieter-Karten auf einer Garmin-Uhr mit Kartenunterstützung mit einem Apple-Silicon-Mac. Verbinde die Uhr, wähle eine Karte oder lade deine eigene .img-Datei hoch und installiere sie mit Terento in drei einfachen Schritten.",
        "intro": "Terento bietet einen klaren Ablauf für Apple Silicon: Uhr verbinden, Karte wählen, Speicher prüfen und installieren.",
        "current_beta": "Vier Kartenanbieter + lokaler Import",
        "compatibility_note": "Die Kompatibilitätsseite zeigt genaue Garmin-Modelle und -Varianten mit mindestens einer erfolgreich geteilten Installation. Die Liste wächst, wenn weitere erfolgreiche Installationen geteilt werden. Wenn ein Modell fehlt, bedeutet das nicht, dass es nicht unterstützt wird; möglicherweise wurde für genau dieses Modell und diese Variante noch keine erfolgreiche Installation geteilt. Terento ist für Garmin-Smartwatches mit Kartenunterstützung gedacht. Nach dem Verbinden prüft Terento deine Uhr und sagt dir, ob du sicher fortfahren kannst.",
        ...
        "step2_body": "Wähle einen der vier Kartenanbieter und eine Region. Terento zeigt Kartengröße und freien Speicher, bevor du installierst. Du kannst auch eine unterstützte Kartendatei von deinem Mac hinzufügen.",
    ...
    "fr": {
        ...
        "meta_description": "Installez des cartes tierces sur une montre Garmin prenant en charge les cartes depuis un Mac Apple Silicon. Connectez la montre, choisissez une carte ou importez votre propre fichier .img, puis installez avec Terento en trois étapes simples.",
        ...
        "current_beta": "Quatre fournisseurs de cartes + import local",
        "compatibility_note": "La page Compatibilité présente les modèles et variantes Garmin exacts avec au moins une installation réussie partagée. La liste s’allonge à mesure que de nouvelles installations réussies sont partagées. L’absence d’un modèle ne signifie pas qu’il n’est pas pris en charge ; il se peut simplement qu’aucune installation réussie n’ait encore été partagée pour ce modèle et cette variante précis. Terento est conçu pour les montres Garmin prenant en charge les cartes. Après la connexion, Terento vérifie votre montre et vous indique si vous pouvez continuer en toute sécurité.",
        ...
        "step2_body": "Choisissez un fournisseur de cartes parmi les trois proposés et une région. Terento affiche la taille de la carte et l’espace disponible avant l’installation. Vous pouvez aussi ajouter un fichier cartographique pris en charge depuis votre Mac.",
    ...
    "pl": {
        ...
        "meta_description": "Instaluj mapy innych firm na zegarku Garmin obsługującym mapy z Maca z Apple Silicon. Podłącz zegarek, wybierz mapę lub dodaj własny plik .img i zainstaluj ją z Terento w trzech prostych krokach.",
        "intro": "Terento zapewnia prosty proces na Macach z Apple Silicon: podłącz zegarek, wybierz mapę, sprawdź pamięć i zainstaluj.",
        "current_beta": "Czterech dostawców map + lokalny import",
        "compatibility_note": "Strona zgodności pokazuje dokładne modele i warianty Garmin z co najmniej jedną udaną, udostępnioną instalacją. Lista rośnie wraz z kolejnymi udanymi instalacjami udostępnianymi przez użytkowników. Brak modelu nie oznacza, że nie jest obsługiwany; być może nie otrzymaliśmy jeszcze udanej instalacji dla dokładnie tego modelu i wariantu. Terento jest przeznaczone dla zegarków Garmin obsługujących mapy. Po podłączeniu Terento sprawdzi zegarek i powie, czy można bezpiecznie kontynuować.",
        ...
        "step2_body": "Wybierz jednego z czterech dostawców map i region. Terento pokaże rozmiar mapy i wolne miejsce przed instalacją. Możesz też dodać obsługiwany plik mapy z Maca.",
    ...
    "cs": {
        ...
        "meta_description": "Instalujte mapy třetích stran do hodinek Garmin s podporou map z Macu s Apple Silicon. Připojte hodinky, vyberte mapu nebo přidejte vlastní soubor .img a nainstalujte ji s Terento ve třech jednoduchých krocích.",
        "intro": "Terento nabízí jasný postup pro Macy s Apple Silicon: připojte hodinky, vyberte mapu, zkontrolujte místo a instalujte.",
        "current_beta": "Tři poskytovatelé map + místní import",
        "compatibility_note": "Stránka Kompatibilita zobrazuje konkrétní modely a varianty Garmin s alespoň jednou úspěšnou sdílenou instalací. Seznam se rozšiřuje s dalšími sdílenými úspěšnými instalacemi. Pokud zde model není, neznamená to, že není podporován; pro daný model a variantu zatím možná nebyla sdílena žádná úspěšná instalace. Terento je určeno pro hodinky Garmin s podporou map. Po připojení Terento hodinky zkontroluje a řekne vám, zda lze bezpečně pokračovat.",
        ...
        "step2_body": "Vyberte jednoho ze čtyř poskytovatelů map a oblast. Terento před instalací zobrazí velikost mapy a volné místo. Z Macu můžete také přidat podporovaný mapový soubor.",
    ...
    "it": {
        ...
        "meta_description": "Installa mappe di terze parti su uno smartwatch Garmin con supporto alle mappe da un Mac Apple Silicon. Collega l’orologio, scegli una mappa o aggiungi il tuo file .img e installa con Terento in tre semplici passaggi.",
        ...
        "current_beta": "Quattro provider di mappe + importazione locale",
        "compatibility_note": "La pagina Compatibilità mostra i modelli e le varianti Garmin esatti con almeno un’installazione riuscita condivisa. L’elenco cresce man mano che vengono condivise altre installazioni riuscite. Se un modello non è nell’elenco, non significa che non sia supportato; potrebbe semplicemente non esserci ancora un’installazione riuscita condivisa per quel modello e quella variante esatti. Terento è progettato per gli smartwatch Garmin con supporto alle mappe. Dopo il collegamento, Terento controlla l’orologio e ti dice se puoi continuare in sicurezza.",
        ...
        "step2_body": "Scegli uno dei quattro provider di mappe e una regione. Terento mostra le dimensioni della mappa e lo spazio disponibile prima dell’installazione. Puoi anche aggiungere un file cartografico supportato dal Mac.",
...
FLOW_COPY = {
    "en": {
        ...
        "compatibility_note": "The Compatibility page shows exact Garmin models and variants with at least one successful shared installation. The list grows as more successful installations are shared. A missing model does not mean it is unsupported; it may simply not have a successful shared installation for that exact model and variant yet. Terento is intended for Garmin smartwatches with map support. After connection, Terento checks the detected device and tells you whether installation can safely continue.",
        "steps_eyebrow": "The workflow",
        ...
        "install_substeps": [("Choose from the catalog", "Choose a region from one of the four map providers in the catalog."), ("Upload your own map", "Add a compatible .img map from your Mac.")],
        ...
        "installation_failed": "On the failed installation screen, choose “Report issue”. Terento opens GitHub with the report already filled in. Review it before posting: GitHub issues are public. For help by email, include your watch model, map region and what happened.",
        "not_visible": "Reconnect or restart the watch and check its map settings. If the map still does not appear, email support with your exact watch model, map region, and what happened.",
        "bottom_eyebrow": "Ready when you are",
    ...
    "de": {
        ...
        "meta_description": "Installiere Drittanbieter-Karten auf einer Garmin-Smartwatch mit Kartenunterstützung von einem Apple-Silicon-Mac. Verbinde die Uhr, wähle eine Karte oder lade deine eigene .img-Datei hoch und installiere sie mit Terento in drei einfachen Schritten.",
        ...
        "install_substeps": [("Aus dem Katalog wählen", "Wähle eine Region aus dem Katalog eines der vier Kartenanbieter."), ("Eigene Karte hochladen", "Füge eine kompatible .img-Karte von deinem Mac hinzu.")],
        ...
        "installation_failed": "Wähle nach einer fehlgeschlagenen Installation „Report issue“. Terento öffnet GitHub mit einem bereits ausgefüllten Bericht. Prüfe ihn vor dem Veröffentlichen: GitHub-Issues sind öffentlich. Für Hilfe per E-Mail nenne dein Uhrenmodell, die Kartenregion und den Fehler.",
        "not_visible": "Verbinde die Uhr erneut oder starte sie neu und prüfe die Karteneinstellungen. Fehlt die Karte weiterhin, nenne dem Support per E-Mail dein genaues Uhrenmodell, die Kartenregion und das Problem.",
    ...
    "fr": {
        ...
        "facts": ["macOS 13+", "Apple Silicon", "Montre Garmin prenant en charge les cartes"],
        "checklist": ["Mac Apple Silicon", "macOS 13 ou version ultérieure", "Montre Garmin prenant en charge les cartes", "Câble USB permettant le transfert de données"],
        "compatibility_note": "La page Compatibilité présente les modèles et variantes Garmin exacts avec au moins une installation réussie partagée. La liste s’allonge à mesure que de nouvelles installations réussies sont partagées. L’absence d’un modèle ne signifie pas qu’il n’est pas pris en charge ; il se peut simplement qu’aucune installation réussie n’ait encore été partagée pour ce modèle et cette variante précis. Terento est conçu pour les montres Garmin prenant en charge les cartes. Après la connexion, Terento vérifie l’appareil détecté et vous indique si l’installation peut continuer en toute sécurité.",
        ...
        "install_substeps": [("Choisir dans le catalogue", "Choisissez une région dans le catalogue de l’un des quatre fournisseurs de cartes."), ("Importer votre carte", "Ajoutez une carte .img compatible depuis votre Mac.")],
        ...
        "installation_failed": "Sur l’écran d’échec de l’installation, choisissez « Report issue ». Terento ouvre GitHub avec le rapport déjà rempli. Vérifiez-le avant de le publier : les issues GitHub sont publiques. Pour une aide par e-mail, indiquez le modèle de votre montre, la région de la carte et ce qui s’est passé.",
        "not_visible": "Reconnectez ou redémarrez la montre et vérifiez ses réglages de carte. Si la carte reste invisible, envoyez au support le modèle exact de la montre, la région de la carte et une description du problème.",
    ...
    "pl": {
        ...
        "compatibility_note": "Strona zgodności pokazuje dokładne modele i warianty Garmin z co najmniej jedną udaną, udostępnioną instalacją. Lista rośnie wraz z kolejnymi udanymi instalacjami udostępnianymi przez użytkowników. Brak modelu nie oznacza, że nie jest obsługiwany; być może nie otrzymaliśmy jeszcze udanej instalacji dla dokładnie tego modelu i wariantu. Terento jest przeznaczone dla zegarków Garmin obsługujących mapy. Po podłączeniu Terento sprawdzi wykryte urządzenie i powie, czy można bezpiecznie kontynuować instalację.",
        ...
        "install_substeps": [("Wybierz z katalogu", "Wybierz region z katalogu jednego z czterech dostawców map."), ("Dodaj własną mapę", "Dodaj zgodną mapę .img z Maca.")],
        ...
        "installation_failed": "Na ekranie nieudanej instalacji wybierz „Report issue”. Terento otwiera GitHuba z już wypełnionym raportem. Sprawdź go przed publikacją: zgłoszenia na GitHubie są publiczne. Jeśli potrzebujesz pomocy e-mailem, podaj model zegarka, region mapy i opisz, co się stało.",
        "not_visible": "Podłącz zegarek ponownie lub uruchom go ponownie i sprawdź ustawienia map. Jeśli mapa nadal się nie pojawia, wyślij do pomocy technicznej dokładny model zegarka, region mapy i opis problemu.",
    ...
    "cs": {
        ...
        "compatibility_note": "Stránka Kompatibilita zobrazuje konkrétní modely a varianty Garmin s alespoň jednou úspěšnou sdílenou instalací. Seznam se rozšiřuje s dalšími sdílenými úspěšnými instalacemi. Pokud zde model není, neznamená to, že není podporován; pro daný model a variantu zatím možná nebyla sdílena žádná úspěšná instalace. Terento je určeno pro hodinky Garmin s podporou map. Po připojení Terento zkontroluje rozpoznané zařízení a řekne vám, zda lze bezpečně pokračovat v instalaci.",
        ...
        "install_substeps": [("Vybrat z katalogu", "Vyberte oblast z katalogu jednoho ze čtyř poskytovatelů map."), ("Přidat vlastní mapu", "Přidejte kompatibilní mapu .img z Macu.")],
        ...
        "installation_failed": "Na obrazovce neúspěšné instalace zvolte „Report issue“. Terento otevře GitHub s již vyplněnou zprávou. Před zveřejněním ji zkontrolujte: hlášení na GitHubu jsou veřejná. Pro pomoc e-mailem uveďte model hodinek, oblast mapy a popis problému.",
        "not_visible": "Hodinky znovu připojte nebo restartujte a zkontrolujte nastavení map. Pokud mapa stále chybí, pošlete podpoře přesný model hodinek, oblast mapy a popis problému.",
    ...
    "it": {
        ...
        "compatibility_note": "La pagina Compatibilità mostra i modelli e le varianti Garmin esatti con almeno un’installazione riuscita condivisa. L’elenco cresce man mano che vengono condivise altre installazioni riuscite. Se un modello non è nell’elenco, non significa che non sia supportato; potrebbe semplicemente non esserci ancora un’installazione riuscita condivisa per quel modello e quella variante esatti. Terento è progettato per gli smartwatch Garmin con supporto alle mappe. Dopo il collegamento, Terento controlla il dispositivo rilevato e ti dice se puoi continuare l’installazione in sicurezza.",
        ...
        "install_substeps": [("Scegli dal catalogo", "Scegli una regione dal catalogo di uno dei quattro provider di mappe."), ("Aggiungi la tua mappa", "Aggiungi una mappa .img compatibile dal Mac.")],
        ...
        "not_visible": "Ricollega o riavvia l’orologio e controlla le impostazioni della mappa. Se la mappa non appare ancora, invia all’assistenza il modello esatto dell’orologio, la regione della mappa e una descrizione del problema.",
