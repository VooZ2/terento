(() => {
  const translations = {
    de: {
      home: {
        description: "Installiere und verwalte Drittanbieter-Karten auf Garmin-Smartwatches mit Kartenunterstützung mit Terento, einer kostenlosen macOS-App für Apple Silicon.",
        ...
        install: "Wähle Karten aus dem Katalog nach Region oder füge deine eigene kompatible .img-Karte hinzu.",
        doneLabel: "Fertig",
        doneStep: "Deine Karten sind installiert und auf deiner Uhr einsatzbereit.",
        manage: "Sieh, was installiert ist, aktualisiere Karten, wenn neuere Versionen verfügbar sind, und entferne von Terento verwaltete Drittanbieter-Karten. Originale Garmin-Karten bleiben geschützt.",
        ...
        faqLabel: "Hast du Fragen?",
        finalCtaEyebrow: "Heute loslegen",
        ...
        faq: [
          ["Welche Garmin-Uhren funktionieren mit Terento?", "Auf der <a href=\"/de/compatibility/\" data-umami-event=\"compatibility-link-click\" data-umami-event-location=\"home-faq-compatibility\">Kompatibilitätsseite</a> findest du genaue Garmin-Modelle und Varianten mit mindestens einer erfolgreich geteilten Installation. Ein fehlendes Modell ist nicht unbedingt ununterstützt."],
          ...
          ["Was soll ich tun, wenn die Installation fehlschlägt?", "Wähle nach einer fehlgeschlagenen Installation „Report issue“. Terento öffnet GitHub mit einem bereits ausgefüllten Bericht. Prüfe ihn vor dem Veröffentlichen: GitHub-Issues sind öffentlich. Für Hilfe per E-Mail nenne dein Uhrenmodell, die Kartenregion und den Fehler.", { support: true }],
        ],
      },
      fr: {
        description: "Installez et gérez des cartes tierces sur les montres Garmin prenant en charge les cartes avec Terento, l’app macOS gratuite pour Apple Silicon.",
        ...
        install: "Choisissez des cartes dans le catalogue par région ou ajoutez votre propre carte .img compatible.",
        doneLabel: "Terminé",
        doneStep: "Vos cartes sont installées et prêtes à être utilisées sur votre montre.",
        manage: "Consultez les cartes installées, mettez-les à jour lorsqu’une version plus récente est disponible et supprimez les cartes tierces gérées par Terento. Les cartes Garmin d’origine restent protégées.",
        ...
        faqLabel: "Vous avez des questions ?",
        finalCtaEyebrow: "Commencez aujourd’hui",
        ...
        faq: [
          ["Quelles montres Garmin fonctionnent avec Terento ?", "Consultez la <a href=\"/fr/compatibility/\" data-umami-event=\"compatibility-link-click\" data-umami-event-location=\"home-faq-compatibility\">page Compatibilité</a> pour voir les modèles et variantes Garmin exacts avec au moins une installation réussie partagée. L’absence d’un modèle ne signifie pas qu’il n’est pas pris en charge."],
          ...
          ["Que dois-je faire si l’installation échoue ?", "Sur l’écran d’échec de l’installation, choisissez « Report issue ». Terento ouvre GitHub avec le rapport déjà rempli. Vérifiez-le avant de le publier : les issues GitHub sont publiques. Pour une aide par e-mail, indiquez le modèle de votre montre, la région de la carte et ce qui s’est passé.", { support: true }],
        ],
      },
      pl: {
        description: "Instaluj i zarządzaj mapami innych firm na zegarkach Garmin obsługujących mapy za pomocą bezpłatnej aplikacji Terento dla Maców z Apple Silicon.",
        ...
        install: "Wybieraj mapy z katalogu według regionu albo dodaj własną zgodną mapę .img.",
        doneLabel: "Gotowe",
        doneStep: "Twoje mapy są zainstalowane i gotowe do użycia na zegarku.",
        manage: "Sprawdź, co jest zainstalowane, aktualizuj mapy, gdy dostępne są nowsze wydania, i usuwaj mapy innych firm zarządzane przez Terento. Oryginalne mapy Garmin pozostają chronione.",
        ...
        faqLabel: "Masz pytania?",
        finalCtaEyebrow: "Zacznij już dziś",
        ...
        faq: [
          ["Jakie zegarki Garmin działają z Terento?", "Na <a href=\"/pl/compatibility/\" data-umami-event=\"compatibility-link-click\" data-umami-event-location=\"home-faq-compatibility\">stronie zgodności</a> znajdziesz dokładne modele i warianty Garmin z co najmniej jedną udaną, udostępnioną instalacją. Brak modelu nie oznacza, że nie jest obsługiwany."],
          ...
          ["Co zrobić, jeśli instalacja się nie powiedzie?", "Na ekranie nieudanej instalacji wybierz „Report issue”. Terento otwiera GitHuba z już wypełnionym raportem. Sprawdź go przed publikacją: zgłoszenia na GitHubie są publiczne. Jeśli potrzebujesz pomocy e-mailem, podaj model zegarka, region mapy i opisz, co się stało.", { support: true }],
        ],
      },
      cs: {
        description: "Instalujte a spravujte mapy třetích stran na hodinkách Garmin s podporou map pomocí bezplatné aplikace Terento pro Macy s Apple Silicon.",
        ...
        install: "Vybírejte mapy z katalogu podle oblasti nebo přidejte vlastní kompatibilní mapu .img.",
        doneLabel: "Hotovo",
        doneStep: "Vaše mapy jsou nainstalované a připravené k použití v hodinkách.",
        manage: "Prohlédněte si nainstalované mapy, aktualizujte je, když je k dispozici novější vydání, a odstraňte mapy třetích stran spravované aplikací Terento. Původní mapy Garmin zůstávají chráněné.",
        ...
        faqLabel: "Máte otázky?",
        finalCtaEyebrow: "Začněte ještě dnes",
        ...
        faq: [
          ["Které hodinky Garmin fungují s Terento?", "Na stránce <a href=\"/cs/compatibility/\" data-umami-event=\"compatibility-link-click\" data-umami-event-location=\"home-faq-compatibility\">Kompatibilita</a> najdete konkrétní modely a varianty Garmin s alespoň jednou úspěšnou sdílenou instalací. Chybějící model nemusí znamenat, že není podporován."],
          ...
          ["Co mám dělat, když instalace selže?", "Na obrazovce neúspěšné instalace zvolte „Report issue“. Terento otevře GitHub s již vyplněnou zprávou. Před zveřejněním ji zkontrolujte: hlášení na GitHubu jsou veřejná. Pro pomoc e-mailem uveďte model hodinek, oblast mapy a popis problému.", { support: true }],
        ],
      },
      it: {
        description: "Installa e gestisci mappe di terze parti sugli smartwatch Garmin con supporto alle mappe usando Terento, l’app macOS gratuita per Apple Silicon.",
        ...
        install: "Scegli le mappe dal catalogo per regione oppure aggiungi la tua mappa .img compatibile.",
        doneLabel: "Fatto",
        doneStep: "Le tue mappe sono installate e pronte per essere usate sullo smartwatch.",
        manage: "Visualizza le mappe installate, aggiornatele quando è disponibile una versione più recente e rimuovi le mappe di terze parti gestite da Terento. Le mappe Garmin originali restano protette.",
        ...
        faqLabel: "Hai domande?",
        finalCtaEyebrow: "Inizia oggi",
        ...
        faq: [
          ["Quali smartwatch Garmin funzionano con Terento?", "Consulta la pagina <a href=\"/it/compatibility/\" data-umami-event=\"compatibility-link-click\" data-umami-event-location=\"home-faq-compatibility\">Compatibilità</a> per i modelli e le varianti Garmin esatti con almeno un’installazione riuscita condivisa. L’assenza di un modello non significa necessariamente che non sia supportato."],
          ...
          ["Cosa devo fare se l’installazione non riesce?", "Nella schermata di installazione non riuscita, scegli “Report issue”. Terento apre GitHub con il rapporto già compilato. Controllalo prima di pubblicarlo: le issue su GitHub sono pubbliche. Per assistenza via e-mail, indica il modello dell’orologio, la regione della mappa e cosa è successo.", { support: true }],
        ],
      },
    },
    download: {
      de: { title: "Terento für Mac herunterladen — Drittanbieter-Karten für Garmin", description: "Lade die kostenlose, notarielle Terento-Beta für Apple-Silicon-Macs herunter, um Drittanbieter-Karten auf Garmin-Smartwatches mit Kartenunterstützung zu installieren und zu verwalten.", intro: "Eine notarierte native macOS-Beta zum Installieren und Verwalten von Drittanbieter-Karten auf Garmin-Smartwatches mit Kartenunterstützung.", requirement: "Apple-Silicon-Mac erforderlich.", requirements: ["macOS 13 oder neuer", "Apple-Silicon-Mac", "Garmin-Smartwatch mit Kartenunterstützung"], status: "Dies ist die aktuelle Terento-Beta. Die Kompatibilitätsseite zeigt genaue Modelle und Varianten mit mindestens einer erfolgreich geteilten Installation; ein fehlendes Modell ist nicht unbedingt ununterstützt.", included: ["Native macOS-App", "Sichere Karteninstallation, Aktualisierung und Entfernung", "Katalog für Drittanbieter-Karten", "Import unterstützter Drittanbieter-.img-Karten vom Mac", "Lokale Installationsdaten"] },
      fr: { title: "Télécharger Terento pour Mac — Cartes tierces pour Garmin", description: "Téléchargez la bêta Terento gratuite et notariée pour Mac Apple Silicon afin d’installer et de gérer des cartes tierces sur les montres Garmin prenant en charge les cartes.", intro: "Une bêta macOS native et notariée pour installer et gérer des cartes tierces sur les montres Garmin prenant en charge les cartes.", requirement: "Mac Apple Silicon requis.", requirements: ["macOS 13 ou version ultérieure", "Mac Apple Silicon", "Montre Garmin prenant en charge les cartes"], status: "Il s’agit de la bêta actuelle de Terento. La page Compatibilité affiche les modèles et variantes exacts avec au moins une installation réussie partagée ; l’absence d’un modèle ne signifie pas qu’il n’est pas pris en charge.", included: ["Application macOS native", "Installation, mise à jour et suppression sûres des cartes", "Catalogue de fournisseurs de cartes tierces", "Import de cartes .img tierces prises en charge depuis le Mac", "Enregistrements locaux des installations"] },
      pl: { title: "Pobierz Terento na Maca — Mapy innych firm dla Garmina", description: "Pobierz bezpłatną, notaryzowaną betę Terento na Maci z Apple Silicon, aby instalować i zarządzać mapami innych firm na zegarkach Garmin obsługujących mapy.", intro: "Notaryzowana natywna beta macOS do instalowania i zarządzania mapami innych firm na zegarkach Garmin obsługujących mapy.", requirement: "Wymaga Maca z Apple Silicon.", requirements: ["macOS 13 lub nowszy", "Mac z Apple Silicon", "Zegarek Garmin obsługujący mapy"], status: "To aktualna beta Terento. Strona zgodności pokazuje dokładne modele i warianty z co najmniej jedną udaną, udostępnioną instalacją; brak modelu nie oznacza, że nie jest obsługiwany.", included: ["Natywna aplikacja macOS", "Bezpieczna instalacja, aktualizacje i usuwanie map", "Katalog dostawców map innych firm", "Import obsługiwanych map .img innych firm z Maca", "Lokalne dane instalacji"] },
      cs: { title: "Stáhnout Terento pro Mac — Mapy třetích stran pro Garmin", description: "Stáhněte si bezplatnou, notářsky ověřenou betu Terento pro Macy s Apple Silicon k instalaci a správě map třetích stran na hodinkách Garmin s podporou map.", intro: "Notářsky ověřená nativní beta pro macOS k instalaci a správě map třetích stran na hodinkách Garmin s podporou map.", requirement: "Vyžaduje Mac s Apple Silicon.", requirements: ["macOS 13 nebo novější", "Mac s Apple Silicon", "Hodinky Garmin s podporou map"], status: "Jde o aktuální betu Terento. Stránka Kompatibilita zobrazuje konkrétní modely a varianty s alespoň jednou úspěšnou sdílenou instalací; chybějící model nemusí znamenat, že není podporován.", included: ["Nativní aplikace pro macOS", "Bezpečná instalace, aktualizace a odstraňování map", "Katalog poskytovatelů map třetích stran", "Import podporovaných map .img třetích stran z Macu", "Místní záznamy instalace"] },
      it: { title: "Scarica Terento per Mac — Mappe di terze parti per Garmin", description: "Scarica la beta gratuita e notarizzata di Terento per Mac Apple Silicon per installare e gestire mappe di terze parti sugli smartwatch Garmin con supporto alle mappe.", intro: "Una beta nativa per macOS, notarizzata, per installare e gestire mappe di terze parti sugli smartwatch Garmin con supporto alle mappe.", requirement: "È richiesto un Mac Apple Silicon.", requirements: ["macOS 13 o versioni successive", "Mac Apple Silicon", "Smartwatch Garmin con supporto alle mappe"], status: "Questa è la beta attuale di Terento. La pagina Compatibilità mostra i modelli e le varianti esatti con almeno un’installazione riuscita condivisa; l’assenza di un modello non significa necessariamente che non sia supportato.", included: ["App macOS nativa", "Installazione, aggiornamento e rimozione sicuri delle mappe", "Catalogo dei provider di mappe di terze parti", "Importazione dal Mac di mappe .img di terze parti supportate", "Registri locali delle installazioni"] },
    },
  };
  ...
  function updateHome(copy) {
    ...
    const actionText = (selector, value) => {
    ...
    const workflowTitle = (value) => {
      const element = document.querySelector("#experience-title");
      if (!element) return;
      element.replaceChildren();
      value.split("→").map((part) => part.trim()).forEach((part, index) => {
        if (index > 0) {
          element.append(" ");
          const arrow = document.createElement("span");
          arrow.className = "workflow-title-arrow";
          arrow.setAttribute("aria-hidden", "true");
          arrow.textContent = "→";
          const bullet = document.createElement("span");
          bullet.className = "workflow-title-bullet";
          bullet.setAttribute("aria-hidden", "true");
          bullet.textContent = "•";
          element.append(arrow, bullet, " ");
    ...
    text("#experience-label", copy.experienceLabel);
    workflowTitle(copy.experienceTitle);
    text("#install-maps-tab", copy.installLabel);
    text("#manage-maps-tab", copy.manageLabel);
    const featureTabs = document.querySelector("[data-map-feature-tabs]");
    if (featureTabs) featureTabs.setAttribute("aria-label", copy.featureTabsLabel);
    text(".problem-statement p:first-child", copy.problem);
    text(".problem-statement p:nth-child(2)", copy.problemSecondary);
    text(".steps .step:nth-child(2) > p:last-child", copy.installStep);
    text(".steps .step:nth-child(3) > h3", copy.doneLabel);
    text(".steps .step:nth-child(3) > p:last-child", copy.doneStep);
    text("#install-maps-title + p", copy.install);
    text("#manage-maps-title + p", copy.manage);
    text("#providers-title", copy.providerTitle);
    text(".provider-copy > p", copy.providerCopy);
    actionText(".hero-download-action", copy.downloadLabel);
    actionText(".final-cta .download-action", copy.downloadLabel);
    text("#faq .section-heading .eyebrow", copy.faqLabel);
    text(".final-cta .eyebrow", copy.finalCtaEyebrow);
    text("#final-cta-title", copy.finalCtaTitle);
    text(".final-cta-copy > p:last-child", copy.finalCtaBody);
