(() => {
  ...
  const definitions = {
    en: {
      ...
      howText: "The current beta supports maps from Freizeitkarte and OpenTopoMap. Public compatibility is based on real installation evidence for exact Garmin models and variants. Each successful installation shared by users helps us confirm compatibility with greater confidence.",
