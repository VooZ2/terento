(() => {
  ...
  const definitions = {
    en: {
      ...
      metaDescription: "See real Terento third-party map installation results by exact Garmin watch model and variant. Compatibility is confirmed through successful installs shared by users.",
    ...
    de: {
      ...
      metaDescription: "Sieh dir echte Terento-Ergebnisse für die Installation von Drittanbieter-Karten nach genauem Garmin-Uhrenmodell und Variante an. Die Kompatibilität wird durch erfolgreiche, von Nutzern geteilte Installationen bestätigt.",
    ...
    fr: {
      ...
      metaDescription: "Consultez les résultats réels d’installation de cartes tierces avec Terento pour chaque modèle et variante de montre Garmin. La compatibilité est confirmée par des installations réussies partagées par les utilisateurs.",
    ...
    pl: {
      ...
      metaDescription: "Zobacz rzeczywiste wyniki instalacji map innych firm przez Terento dla konkretnego modelu i wariantu zegarka Garmin. Kompatybilność jest potwierdzana na podstawie udanych instalacji udostępnionych przez użytkowników.",
    ...
    cs: {
      ...
      metaDescription: "Prohlédněte si skutečné výsledky instalace map třetích stran pomocí Terento pro konkrétní model a variantu hodinek Garmin. Kompatibilita se potvrzuje úspěšnými instalacemi sdílenými uživateli.",
    ...
    it: {
      ...
      metaDescription: "Scopri i risultati reali di installazione di mappe di terze parti con Terento per ogni modello e variante di smartwatch Garmin. La compatibilità è confermata dalle installazioni riuscite condivise dagli utenti.",
