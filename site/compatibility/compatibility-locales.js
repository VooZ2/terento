(() => {
  ...
  const definitions = {
    en: {
      ...
      howText: "The current beta supports maps from three map providers. Public compatibility is based on real installation evidence for exact Garmin models and variants. Each successful installation shared by users helps us confirm compatibility with greater confidence.",
    ...
    de: {
      ...
      howText: "Die aktuelle Beta unterstützt Karten von drei Kartenanbietern. Die öffentliche Kompatibilität basiert auf echten Installationsnachweisen für genaue Garmin-Modelle und Varianten. Jede von Nutzern geteilte erfolgreiche Installation hilft uns, die Kompatibilität verlässlicher zu bestätigen.",
    ...
    fr: {
      ...
      howText: "La bêta actuelle prend en charge les cartes de trois fournisseurs de cartes. La compatibilité publique repose sur des preuves réelles d’installation pour des modèles et variantes Garmin précis. Chaque installation réussie partagée par les utilisateurs nous aide à confirmer la compatibilité avec plus de certitude.",
    ...
    pl: {
      ...
      howText: "Aktualna beta obsługuje mapy od trzech dostawców. Publiczna kompatybilność opiera się na rzeczywistych dowodach instalacji dla konkretnych modeli i wariantów Garmin. Każda udana instalacja udostępniona przez użytkownika pomaga nam potwierdzać kompatybilność z większą pewnością.",
    ...
    cs: {
      ...
      howText: "Aktuální beta podporuje mapy od tří poskytovatelů. Veřejná kompatibilita vychází ze skutečných instalačních výsledků pro konkrétní modely a varianty Garmin. Každá úspěšná instalace sdílená uživateli nám pomáhá potvrdit kompatibilitu s větší jistotou.",
    ...
    it: {
      ...
      howText: "La beta attuale supporta le mappe di tre provider. La compatibilità pubblica si basa su risultati reali di installazione per modelli e varianti Garmin esatti. Ogni installazione riuscita condivisa dagli utenti ci aiuta a confermare la compatibilità con maggiore sicurezza.",
