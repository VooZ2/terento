...
class AdminSemanticsTests(unittest.TestCase):
    ...
    def test_map_statistics_fallback_matches_provider_region_aliases_to_explicit_events(self):
        ...
        self.assertIn("coverage-map-v1.js?v=20260913-full-width-2", body)
        ...
        self.assertIn(".map-statistics-coverage-layout{align-items:start;grid-template-columns:minmax(0,1fr)}", body)
        ...
        self.assertNotIn(".map-statistics-world-map-card{position:sticky", body)
