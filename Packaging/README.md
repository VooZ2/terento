...
```sh
Packaging/release.sh --version 1.0.0 --build 3
```
...
```text
dist/Terento-1.0.0-beta.4-macOS-arm64.zip
dist/Terento-1.0.0-beta.4-macOS-arm64.dmg
```
...
```sh
Packaging/release.sh --no-notarize --version 1.0.0 --build 3
```
