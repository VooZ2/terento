...
```sh
Packaging/release.sh --version 1.0.0 --build 4
```
...
```text
dist/Terento-1.0.0-beta.5-macOS-arm64.zip
dist/Terento-1.0.0-beta.5-macOS-arm64.dmg
```
...
```sh
Packaging/release.sh --no-notarize --version 1.0.0 --build 4
```
